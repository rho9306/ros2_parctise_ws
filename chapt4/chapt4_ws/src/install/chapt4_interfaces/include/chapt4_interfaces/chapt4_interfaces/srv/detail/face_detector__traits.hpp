...
[[deprecated("use chapt4_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const chapt4_interfaces::srv::FaceDetector_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  chapt4_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use chapt4_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const chapt4_interfaces::srv::FaceDetector_Event & msg)
{
  return chapt4_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<chapt4_interfaces::srv::FaceDetector_Event>()
{
  return "chapt4_interfaces::srv::FaceDetector_Event";
}

template<>
inline const char * name<chapt4_interfaces::srv::FaceDetector_Event>()
{
  return "chapt4_interfaces/srv/FaceDetector_Event";
}

template<>
struct has_fixed_size<chapt4_interfaces::srv::FaceDetector_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<chapt4_interfaces::srv::FaceDetector_Event>
  : std::integral_constant<bool, has_bounded_size<chapt4_interfaces::srv::FaceDetector_Request>::value && has_bounded_size<chapt4_interfaces::srv::FaceDetector_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<chapt4_interfaces::srv::FaceDetector_Event>
  : std::true_type {};
