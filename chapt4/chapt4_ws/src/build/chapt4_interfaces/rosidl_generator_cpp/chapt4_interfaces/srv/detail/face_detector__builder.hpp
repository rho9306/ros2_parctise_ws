...
{
public:
  explicit Init_FaceDetector_Event_response(::chapt4_interfaces::srv::FaceDetector_Event & msg)
  : msg_(msg)
  {}
  ::chapt4_interfaces::srv::FaceDetector_Event response(::chapt4_interfaces::srv::FaceDetector_Event::_response_type arg)
  {
...
private:
  ::chapt4_interfaces::srv::FaceDetector_Event msg_;
};

class Init_FaceDetector_Event_request
{
public:
  explicit Init_FaceDetector_Event_request(::chapt4_interfaces::srv::FaceDetector_Event & msg)
  : msg_(msg)
  {}
  Init_FaceDetector_Event_response request(::chapt4_interfaces::srv::FaceDetector_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FaceDetector_Event_request info(::chapt4_interfaces::srv::FaceDetector_Event::_info_type arg)
  {
...
template<>
inline
auto build<::chapt4_interfaces::srv::FaceDetector_Event>()
{
  return chapt4_interfaces::srv::builder::Init_FaceDetector_Event_info();
}
