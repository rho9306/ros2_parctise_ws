...
void FaceDetector_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) chapt4_interfaces::srv::FaceDetector_Event(_init);
}

void FaceDetector_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<chapt4_interfaces::srv::FaceDetector_Event *>(message_memory);
  typed_message->~FaceDetector_Event();
}

size_t size_function__FaceDetector_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<chapt4_interfaces::srv::FaceDetector_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<chapt4_interfaces::srv::FaceDetector_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<chapt4_interfaces::srv::FaceDetector_Request> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__FaceDetector_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const chapt4_interfaces::srv::FaceDetector_Request *>(
    get_const_function__FaceDetector_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<chapt4_interfaces::srv::FaceDetector_Request *>(untyped_value);
  value = item;
}
...
void assign_function__FaceDetector_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<chapt4_interfaces::srv::FaceDetector_Request *>(
    get_function__FaceDetector_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const chapt4_interfaces::srv::FaceDetector_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<chapt4_interfaces::srv::FaceDetector_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<chapt4_interfaces::srv::FaceDetector_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<chapt4_interfaces::srv::FaceDetector_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__FaceDetector_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const chapt4_interfaces::srv::FaceDetector_Response *>(
    get_const_function__FaceDetector_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<chapt4_interfaces::srv::FaceDetector_Response *>(untyped_value);
  value = item;
}
...
void assign_function__FaceDetector_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<chapt4_interfaces::srv::FaceDetector_Response *>(
    get_function__FaceDetector_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const chapt4_interfaces::srv::FaceDetector_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FaceDetector_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chapt4_interfaces::srv::FaceDetector_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(chapt4_interfaces::srv::FaceDetector_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(chapt4_interfaces::srv::FaceDetector_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FaceDetector_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(chapt4_interfaces::srv::FaceDetector_Event),
  false,  // has_any_key_member_
...
{
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chapt4_interfaces, srv, FaceDetector_Event)() {
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t FaceDetector_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Event>(),
