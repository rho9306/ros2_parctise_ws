...
static const _FaceDetector_Event_type_support_symbol_names_t _FaceDetector_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chapt4_interfaces, srv, FaceDetector_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chapt4_interfaces, srv, FaceDetector_Event)),
  }
};
...
{
  return &::chapt4_interfaces::srv::rosidl_typesupport_cpp::FaceDetector_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, chapt4_interfaces, srv, FaceDetector_Event)() {
  return get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Event>();
}
...
static const rosidl_service_type_support_t FaceDetector_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<chapt4_interfaces::srv::FaceDetector_Event>(),
