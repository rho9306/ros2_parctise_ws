...
class Init_Partol_Event_response
{
public:
  explicit Init_Partol_Event_response(::chapt4_interfaces::srv::Partol_Event & msg)
  : msg_(msg)
  {}
  ::chapt4_interfaces::srv::Partol_Event response(::chapt4_interfaces::srv::Partol_Event::_response_type arg)
  {
...
private:
  ::chapt4_interfaces::srv::Partol_Event msg_;
};

class Init_Partol_Event_request
{
public:
  explicit Init_Partol_Event_request(::chapt4_interfaces::srv::Partol_Event & msg)
  : msg_(msg)
  {}
  Init_Partol_Event_response request(::chapt4_interfaces::srv::Partol_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Partol_Event_response(msg_);
  }
...
class Init_Partol_Event_info
{
public:
  Init_Partol_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Partol_Event_request info(::chapt4_interfaces::srv::Partol_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Partol_Event_request(msg_);
  }
...
template<>
inline
auto build<::chapt4_interfaces::srv::Partol_Event>()
{
  return chapt4_interfaces::srv::builder::Init_Partol_Event_info();
}
