...
enum
{
  chapt4_interfaces__srv__Partol_Event__request__MAX_SIZE = 1
};
// response
enum
{
  chapt4_interfaces__srv__Partol_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Partol in the package chapt4_interfaces.
typedef struct chapt4_interfaces__srv__Partol_Event
{
  service_msgs__msg__ServiceEventInfo info;
  chapt4_interfaces__srv__Partol_Request__Sequence request;
  chapt4_interfaces__srv__Partol_Response__Sequence response;
} chapt4_interfaces__srv__Partol_Event;

// Struct for a sequence of chapt4_interfaces__srv__Partol_Event.
typedef struct chapt4_interfaces__srv__Partol_Event__Sequence
{
