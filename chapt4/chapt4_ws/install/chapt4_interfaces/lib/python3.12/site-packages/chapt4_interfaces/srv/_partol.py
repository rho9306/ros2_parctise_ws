...
class Metaclass_Partol_Event(type):
    """Metaclass of message 'Partol_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__partol__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__partol__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__partol__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__partol__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__partol__event
...
class Partol_Event(metaclass=Metaclass_Partol_Event):
    """Message class 'Partol_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<chapt4_interfaces/Partol_Request, 1>',
        'response': 'sequence<chapt4_interfaces/Partol_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['chapt4_interfaces', 'srv'], 'Partol_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['chapt4_interfaces', 'srv'], 'Partol_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from chapt4_interfaces.srv import Partol_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Partol_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Partol_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from chapt4_interfaces.srv import Partol_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Partol_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Partol_Response'"
...
class Metaclass_Partol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _partol.Metaclass_Partol_Event._TYPE_SUPPORT is None:
                _partol.Metaclass_Partol_Event.__import_type_support__()
...
class Partol(metaclass=Metaclass_Partol):
    ...
    from chapt4_interfaces.srv._partol import Partol_Event as Event
