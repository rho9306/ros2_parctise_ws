...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.net_cent = kwargs.get('net_cent', float())
    ...
    def __eq__(self, other):
        ...
        if self.memory_available != other.memory_available:
            return False
        if self.net_cent != other.net_cent:
            return False
    ...
    @builtins.property
    def net_cent(self):
        """Message field 'net_cent'."""
        return self._net_cent

    @net_cent.setter
    def net_cent(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'net_cent' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'net_cent' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._net_cent = value
