...
class Init_SystemStatus_net_cent
{
public:
  explicit Init_SystemStatus_net_cent(::status_interfaces::msg::SystemStatus & msg)
  : msg_(msg)
  {}
  Init_SystemStatus_net_recv net_cent(::status_interfaces::msg::SystemStatus::_net_cent_type arg)
  {
    msg_.net_cent = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemStatus_net_cent memory_available(::status_interfaces::msg::SystemStatus::_memory_available_type arg)
  {
    msg_.memory_available = std::move(arg);
    return Init_SystemStatus_net_cent(msg_);
  }
